...
if (isset($parametros[0]))
  if ($parametros[0] == "formatos")
    getFormatos();
  else if ($parametros[0] == 'ciudades')
    getCiudades();
  else if ($parametros[0] == 'cines')
    getCines();
  else if ($parametros[0] == 'peliculas')
    getPeliculas();
  else if ($parametros[0] == 'cinepeliculas')
    getCinePeliculass();
  else if ($parametros[0] == 'usuarios')
    getUsuarios();
  else if ($parametros[0] == 'socios')
    getSocios();
...
function getUsuarios()
{
  ...
  if (isset($parametros[1])) {
    if ($parametros[1] == "guardar")
      echo getUsuarioGuardar();
    else if ($parametros[1] == "login")
      echo getUsuarioLogin();
    else if ($parametros[1] == "correo")
      echo getUsuarioCorreo();
    else if ($parametros[1] == "passwordd")
      echo setUsuarioPasswordd();
    else if ($parametros[1] == "usuarios")
      echo getUsuariosList();
  }
}
...
function getUsuarioCorreo()
{
  ...
  if (isset($correo)) {
    if (empty($correo))
      return getJSON(false, null, "Correo inválidos");
...
function getSocios()
{
  ...
  if (isset($parametros[1])) {
    if ($parametros[1] == "guardar")
      echo getSocioGuardar();
    else if ($parametros[1] == "login")
      echo getSocioLogin();
    else if ($parametros[1] == "correo")
      echo getSocioCorreo();
    else if ($parametros[1] == "passwordd")
      echo setSocioPasswordd();
  }
}
...
function getSocioGuardar()
{
  return getJSON(false, null, "Parámetros inválidos");
}
function getSocioCorreo()
{
  return getJSON(false, null, "Parámetros inválidos");
}
function getSocioPasswordd()
{
  return getJSON(false, null, "Parámetros inválidos");
}
function setSocioPasswordd()
{
  return getJSON(false, null, "Parámetros invalidos");
}
